...
@RestController
@RequestMapping(value = "api/roles/", consumes = MediaType.APPLICATION_JSON_VALUE)
public class RoleController {
    ...
    public ResponseEntity<userRole>getRoleByUserAndMicrosservice(@PathVariable Integer id_user,@PathVariable Integer id_microsservice){
